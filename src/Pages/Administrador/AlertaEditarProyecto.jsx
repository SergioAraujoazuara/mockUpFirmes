...
function AlertaEditarProyecto({ message, closeModal }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-black bg-opacity-80">
            <div className="relative w-full max-w-md p-5 mx-2 my-6 bg-white rounded-md shadow-lg sm:mx-auto md:p-8 ">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className='flex justify-center items-center w-full'>
                        {message === 'Actualizado correctamente' ? (
                            <IoMdCheckboxOutline style={{ fontSize: 70, fill: '#10b981' }} />
                        ) : (
...
export default AlertaEditarProyecto;
