...
function PrognosisEvolucion() {
  ...
  const indicators = ['CRT', 'IRI', 'Deflexion'];
  ...
  const provinces = [
    ...
    'Huesca', 'Jaén', 'La Rioja', 'León', 'Lleida', 'Lugo', 'Madrid', 'Málaga',
    'Murcia', 'Ourense', 'Palencia', 'Pontevedra', 'Salamanca', 'Segovia',
    'Sevilla', 'Soria', 'Tarragona', 'Teruel', 'Toledo', 'Valencia',
    'Valladolid', 'Zamora', 'Zaragoza'
  ];

  const years = Array.from({ length: 20 }, (_, i) => (i + 1).toString());
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <button
                onClick={() => console.log('Indicador:', selectedIndicator)}
            ...
            <div className="space-y-2">
              ...
              <button
                onClick={() => console.log('Carretera:', selectedRoad)}
                className="w-full bg-sky-600 text-white py-1.5 px-3 rounded-lg text-sm font-medium hover:bg-sky-700 transition-colors"
              >
                Aplicar
              </button>
            ...
            {/* Pronóstico Años */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-gray-600">Pronóstico (años)</label>
              <div className="relative">
                <select
                  value={selectedYears}
...
export default PrognosisEvolucion;
